...
def current_season_id() -> str:
    now = datetime.now()
    if now.month >= 10:
        return f"{now.year}10"
    elif now.month >= 7:
        return f"{now.year}07"
    elif now.month >= 4:
